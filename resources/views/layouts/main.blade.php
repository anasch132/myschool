...
<body class="bg-gray-50">
    <header class="shadow-md bg-white sticky top-0 z-50">
        <div class="max-w-screen-xl p-4 mx-auto">
          <div class="flex items-center justify-between space-x-4 lg:space-x-10">
            ...
            <div class="items-center justify-end flex-1 space-x-4 sm:flex">
              <a
    ...
    {{-- <div class='container px-2 w-full'> --}}
        <div id="overlay">
            <div id="spinner"><svg role="status" class="inline w-10 h-10 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
