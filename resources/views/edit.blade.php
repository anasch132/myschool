            ...
            <form class="space-y-4 my-4" id="storecontact" name="storecontact">
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <label id="firstname" class="relative block p-3 border-2 border-gray-200 rounded-lg" for="firstname">
                    ...
                    <input value="{{$user['fields']['all']['firstname']}}" onfocus="removeError(this)" required class="w-full p-0 text-sm border-none focus:ring-0"  name="firstname" type="text" placeholder="John" />
                  </label>
                  ...
                  <label id="lastname" class="relative block p-3 border-2 border-gray-200 rounded-lg" for="lastname">
                    ...
                    <input value="{{$user['fields']['all']['lastname']}}" onfocus="removeError(this)" required class="w-full p-0 text-sm border-none focus:ring-0"  name="lastname" type="text" placeholder="Doe" />
                  </label>
                  ...
                  <label id="email" class="relative block p-3 border-2 border-gray-200 rounded-lg" for="email">
                    ...
                    <input value="{{$user['fields']['all']['email']}}" onfocus="removeError(this)" class="w-full p-0 text-sm border-none focus:ring-0" name="email" type="email" placeholder="JohnDoe@example.com" />
                  </label>
                  ...
                  <label class="relative block p-3 border-2 border-gray-200 rounded-lg" id="phone" for="phone">
                    ...
                    <input value="{{$user['fields']['all']['phone']}}" onfocus="removeError(this)" class="w-full p-0 text-sm border-none focus:ring-0"  name="phone" type="number" placeholder="00123456789" />
                  </label>
              </div>
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <label class="relative block p-3 border-2 border-gray-200 rounded-lg" id="address1" for="address1">
                    ...
                    <input value="{{$user['fields']['all']['address1']}}" onfocus="removeError(this)" class="w-full p-0 text-sm border-none focus:ring-0"  name="address1" type="text" placeholder="address 1" />
                  </label>
                  ...
                  <label class="relative block p-3 border-2 border-gray-200 rounded-lg" id="address2" for="address2">
                    ...
                    <input value="{{$user['fields']['all']['address2']}}" onfocus="removeError(this)" class="w-full p-0 text-sm border-none focus:ring-0"  name="address2" type="text" placeholder="address 2" />
                  </label>
              </div>
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <label class="relative block p-3 border-2 border-gray-200 rounded-lg" id="city" for="city">
                    ...
                    <input value="{{$user['fields']['all']['city']}}" onfocus="removeError(this)" class="w-full p-0 text-sm border-none focus:ring-0"  name="city" type="text" placeholder="Montreal" />
                  </label>
                  ...
                  <label id="state" class="relative block p-3 border-2 border-gray-200 rounded-lg" for="state">
                    ...
                    <input value="{{$user['fields']['all']['state']}}" onfocus="removeError(this)"  class="w-full p-0 text-sm border-none focus:ring-0" name="state" type="text" placeholder="LA" />
                </label>
                  ...
                  <label class="relative block p-3 border-2 border-gray-200 rounded-lg" id="nationality" for="nationality">
                    ...
                    <input value="{{$user['fields']['all']['nationality']}}" onfocus="removeError(this)" class="w-full p-0 text-sm border-none focus:ring-0" name="nationality"  type="text" placeholder="Canada" />
                  </label>
                </div>
                <div class="flex items-start justify-start">
                    <div class="datepicker form-floating mb-3 border-gray-200 relative block p-3 border-2 rounded-lg" data-mdb-toggle-button="false">
                      <input value="{{$user['fields']['all']['birth_date']}}" onfocus="removeError(this)" type="text"
